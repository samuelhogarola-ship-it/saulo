        ...
        <section class="events-hero events-hero--marked">
          ...
          <div class="events-hero__copy">
            ...
            <div class="events-hero__actions">
              ...
              <a class="secondary-link" href="https://wa.me/34622923988" target="_blank" rel="noreferrer">${escapeHtml(
                copy.whatsAppLabel,
              )}</a>
            </div>
          </div>
          <div class="events-hero__next">
            ...
            <strong>${escapeHtml(featuredEvent ? featuredEvent.title : copy.emptyEventsTitle)}</strong>
          </div>
        </section>
          ...
          ${
            events.length
              ...
              : `<article class="events-empty-state">
                  <p class="section-label">${escapeHtml(copy.upcomingLabel)}</p>
                  <h2>${escapeHtml(copy.emptyEventsTitle)}</h2>
                  <p>${escapeHtml(copy.emptyEventsDescription)}</p>
                  <a class="secondary-link secondary-link--whatsapp" href="https://wa.me/34622923988" target="_blank" rel="noreferrer">${escapeHtml(copy.whatsAppLabel)}</a>
                </article>`
          }
        </section>
...
<html lang="${escapeAttribute(lang === 'pt-br' ? 'pt-BR' : 'es')}">
  <head>
    ...
    <link rel="icon" href="/app/icons/icon-192.png?v=saulo-v13" type="image/png" />
...
function getEventsCopy(lang) {
  if (lang === 'pt-br') {
    return {
      ...
      eventsScript:
        'Energia real, treino guiado e uma experiência para sair diferente.',
  ...
  return {
    ...
    eventsScript:
      'Energía real, entrenamiento guiado y una experiencia para salir diferente.',
    viewAgendaLabel: 'Ver agenda',
