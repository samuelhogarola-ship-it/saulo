            ...
            .map(
              (event) => `
                <article class="event-card">
                  <div class="event-card__poster" style="background-image:url('${escapeAttribute(
                    event.posterUrl,
                  )}')"></div>
                  <div class="event-card__body">
                    <p class="event-card__meta">${escapeHtml(formatEventDate(event.startsAt, lang))} · ${escapeHtml(
                      event.location,
                    )}</p>
    ...
    body: `
      ...
      <main class="event-detail-shell">
        ...
        <section class="event-detail-hero">
          <div class="event-detail-hero__media" style="background-image:url('${escapeAttribute(
            event.posterUrl,
          )}')"></div>
...
function getEventsCopy(lang) {
  if (lang === 'pt-br') {
    return {
      ...
      eventsHeading: 'Treinos ao vivo para viver a mudança com você.',
      eventsLead:
        'Encontros pensados para treinar, te motivar e sair com uma estratégia clara.',
  ...
  return {
    ...
    eventsKicker: 'Eventos Saulo Fitness',
    eventsHeading: 'Entrenamientos en directo para vivir el cambio contigo.',
    eventsLead:
      'Encuentros pensados para entrenar, motivarte y salir con una estrategia clara.',
